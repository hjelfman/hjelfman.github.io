...
There is also an interesting demographic breakdown here (insert link). Personally, I've been on twitter for quite a bit, know about tech developments (but tend not to use them), and have a mild interest in woo and rationalism. Though I've known about it since it started, @rebqcd convinced me to go to this one (it helped that I'd recently realized that I hadn't taken a true vacation since I started working full time).
